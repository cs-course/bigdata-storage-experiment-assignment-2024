...
from swiftbench2.bench import (BenchController, DistributedBenchController,
                              create_containers, delete_containers)
from swiftbench2.utils import readconf, config_true_value
...
def main(argv):
    ...
    logger.setLevel({
        ...
        'critical': logging.CRITICAL}.get(
            options.log_level.lower(), logging.DEBUG))
